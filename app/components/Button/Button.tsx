...
export const Button = ({ color = 'primary', size = 'large', variant = 'solid', children, ...props }: ButtonProps) => {
  ...
  return (
    <button
      className={`${baseStyles} ${colorStyles[color]} ${variantStyles[variant]} ${sizeStyles[size]}`}
      {...props}
    >
      {children}
    </button>
